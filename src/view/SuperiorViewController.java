...
public class SuperiorViewController implements ViewModule {
	...
	private void initialize() {
		...
		new SuperiorEmployeeTab(controller, empNameText, empIdText, empLicenseLabelHolder, empLicenseText, addEmpButton,
				updateEmpButton, deleteEmpButton, empTableView);
		// pass all Vehicle related elements to the Vehicle tab handler
		new SuperiorVehicleTab(controller, brandText, modelText, regPlateText, drivenText, cargoText, maintainedText,
		...
		new SuperiorDrivingShiftTab(controller, shiftClientText, shiftIdText, shiftCargoText, shiftDeadlineText,
				shiftAddButton, shiftUpdateButton, shiftDeleteButton, shiftTableView);
