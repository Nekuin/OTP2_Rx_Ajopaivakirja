...
public class SuperiorVehicleTab implements UndoObserver, SubmitObserver {
	 ...
	 */
	public SuperiorVehicleTab(IController controller, Text brandText, Text modelText, Text regPlateText, Text drivenText, Text cargoText, Text maintainedText, Button addVehicleButton, Button updateVehicleButton, Button deleteVehicleButton, TableView<Vehicle> vehicleTableView) {
	...
	private void setupColumns() {
		...
		vehicleTableView.setOnMouseClicked(e -> {
			Vehicle clicked = vehicleTableView.getSelectionModel().getSelectedItem();
			if(clicked != null) {
				String maintained = (clicked.getMaintained()) ? strings.getString("sup_veh_yes_maintain_text") : strings.getString("sup_veh_no_maintain_text");
	 ...
	 * index 2 regPlateText, index 3 drivenText, index 4 cargoText
	 * and index 5 maintainedText
	 * @param strings
	 */
